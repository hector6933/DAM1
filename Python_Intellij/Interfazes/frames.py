...
radiobutton1 = ttk.Radiobutton(frame, text="Hombre")
radiobutton2 = ttk.Radiobutton(frame, text="Mujer")
...
checkbutton1 = ttk.Checkbutton(frame2, text="Cine")
checkbutton2 = ttk.Checkbutton(frame2, text="Viajes")
checkbutton3 = ttk.Checkbutton(frame2, text="Deportes")
...
radiobutton3 = ttk.Radiobutton(frame3, text="Estudios Básicos")
radiobutton4 = ttk.Radiobutton(frame3, text="Estudios Medios")
radiobutton5 = ttk.Radiobutton(frame3, text="Estudios Avanzados")
