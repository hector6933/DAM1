...
public class Demo1 {
    ...
    public static void main(String[] args) {
        ...
        Alumno alumno1 = new Alumno("Nombre 1","Apellido 1",33,"19491836R", Date.valueOf("2025-01-01"));
        Alumno alumno2 = new Alumno("Nombre 2","Apellido 2",69,"49030103T", Date.valueOf("2009-12-03"));
        Alumno alumno3 = new Alumno("Nombre 3","Apellido 3",22,"12312352F", Date.valueOf("2020-12-03"));
        Alumno alumno4 = new Alumno("Nombre 4","Apellido 4",5,"93898328R", Date.valueOf("1990-12-03"));
        Alumno alumno5 = new Alumno("Nombre 5","Apellido 5",100,"I293I3G", Date.valueOf("2026-12-03"));
